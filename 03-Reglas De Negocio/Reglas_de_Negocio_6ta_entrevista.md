...
- **RN-05** El stock de un producto se compone de stock vigente y stock vencido.
...
- **RN-13** El stock vencido no se puede descontar del total mientras el producto siga físicamente en el edificio: solo se descuenta al leer su etiqueta en el momento del retiro.
...
- **RN-15** Cuando un producto alcanza su fecha de vencimiento, su stock vigente pasa a contabilizarse como stock vencido.
- **RN-16** Cuando el stock total de un producto queda en o por debajo de su mínimo, el sistema lo marca en el listado de productos con stock bajo.
...
- **RN-19** El stock total de un producto se calcula como la suma de su stock vigente más su stock vencido.
...
- **RN-22** Si el stock total de un producto llega o baja de su stock mínimo, se concluye que el producto requiere reposición.
